...
SaturnApp.prototype.init = function(param)
{
    ...
    // Create Saturn and add it to our sim
    var saturn = new Saturn();
    saturn.init();
    this.addObject(saturn);

    var saturnRings = new SaturnRings();
    saturnRings.init();
    this.addObject(saturnRings);
...
{
	// "I feel the Saturn move..."
	this.object3D.rotation.y += Saturn.ROTATION_Y;
}

Saturn.ROTATION_Y = 0.0025;
Saturn.TILT = 0.41;
...
SaturnRings.prototype = new Sim.Object();

SaturnRings.prototype.init = function() {
    // Create our Saturn with nice texture
...
SaturnRings.prototype.update = function()
{
    // "I feel the Saturn move..."
    this.object3D.rotation.y += Saturn.ROTATION_Y;
}
...
{
    // Create a point light to show off Saturn - set the light out back and to left a bit
